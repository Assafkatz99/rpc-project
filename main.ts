...
let reset_button = document.getElementById("reset_button_id") as HTMLButtonElement | null
...
let rules_button = document.getElementById("rules_button_id") as HTMLButtonElement | null
rules_button?.addEventListener("click", () => {
    ...
    let exit_rules_button = document.getElementById("exit_rules_id") as HTMLButtonElement | null
...
let paperb = document.getElementById("paper_button_id") as HTMLDivElement | null;
...
let scissorsb = document.getElementById("scissors_button_id") as HTMLDivElement | null;
...
const buttle = (arg:IGameHands) => {
    ...
    let left_bubble = document.getElementById("left_bubble") as HTMLDivElement | null;
    left_bubble?.classList.add(arg["userHand"])

    let right_bubble = document.getElementById("right_bubble") as HTMLDivElement | null;
    right_bubble?.classList.add("grey")

    let step_twonthree = document.querySelector(".step_twonthree") as HTMLDivElement
    step_twonthree.style.display = "flex";

    setTimeout(() => {

        let randomNum : number = Math.floor(Math.random()*Object.keys(hands).length)
        ...
        setTimeout(() =>{
            ...
            let result_notice_span_id = document.getElementById("result_notice_span_id") as HTMLSpanElement
            ...
            let headlines_step_twonthree = document.querySelector(".headlines_step_twonthree") as HTMLDivElement
            headlines_step_twonthree.style.gap = "40vw"

            let bubbles_div_step_twonthree = document.querySelector(".bubbles_div_step_twonthree") as HTMLDivElement
            ...
            let play_again_button_idules_button = document.getElementById("play_again_button_id") as HTMLButtonElement | null
